...
if (isset($_GET['delete_id'])) {
    ...
    header("Location: all-products.php?category=$selected_category");
    exit();
}
?>
...
<body>
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<a href="all-products.php?category='. $category. '&delete_id=' . $item_id . '" class="btn btn-delete">Delete</a>';
            echo "</td>";
            echo "</tr>";
        }
