...
if (isset($_POST['update_quantity'])) {
    ...
    if ($new_quantity > 0) {
        $update_query = "UPDATE cart_products SET quantity = $new_quantity
         WHERE id = $cart_id AND status='cart'";
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-row">
                     ...
                     <div class="select_location">
                        <p>Choose Location:</p>
                        <p><a href="map.php"><i class="fa-solid fa-map-location-dot"></i></a></p>
                    </div>
