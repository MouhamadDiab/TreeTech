    ...
    <form action="" method="POST">
        ...
        if (isset($_POST['addToCart']) && isset($_GET["ID"])) {
            ...
            if (mysqli_num_rows($productResult) > 0) {
                ...
                $sql ="INSERT INTO cart_products (cart_id, product_id, quantity,status, price, latitude, longitude) 
                       SELECT $cart_id AS cart_id, i.Item_ID AS product_id, 1 AS quantity, 'cart' , 0, 10.44563, 20.35346
                       FROM items i 
